...
## Notes -- newest first
2026-04: Icinga2 version 2.16 introduce new build system; it now requires ``ninja-build`` from CRB repository, EL9 patch script disables OPENTELEMETRY because correct build requires version 1.19
